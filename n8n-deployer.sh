...
N8N_EXECUTIONS_DATA_PRUNE="${N8N_EXECUTIONS_DATA_PRUNE:-false}"
N8N_EXECUTIONS_DATA_MAX_AGE="${N8N_EXECUTIONS_DATA_MAX_AGE:-336}"
N8N_EXECUTIONS_DATA_PRUNE_MAX_COUNT="${N8N_EXECUTIONS_DATA_PRUNE_MAX_COUNT:-10000}"
...
load_existing_configuration() {
    ...
    N8N_DEFAULT_BINARY_DATA_MODE=$(read_env_var "N8N_DEFAULT_BINARY_DATA_MODE" "${N8N_DEFAULT_BINARY_DATA_MODE}")
    N8N_EXECUTIONS_DATA_PRUNE=$(read_env_var "N8N_EXECUTIONS_DATA_PRUNE" "${N8N_EXECUTIONS_DATA_PRUNE}")
    N8N_EXECUTIONS_DATA_MAX_AGE=$(read_env_var "N8N_EXECUTIONS_DATA_MAX_AGE" "${N8N_EXECUTIONS_DATA_MAX_AGE}")
    N8N_EXECUTIONS_DATA_PRUNE_MAX_COUNT=$(read_env_var "N8N_EXECUTIONS_DATA_PRUNE_MAX_COUNT" "${N8N_EXECUTIONS_DATA_PRUNE_MAX_COUNT}")
